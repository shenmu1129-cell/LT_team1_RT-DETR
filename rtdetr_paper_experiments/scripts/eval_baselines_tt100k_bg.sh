...
OUTPUT_PREFIX="${OUTPUT_PREFIX:-rtdetr_paper_experiments/results/table2_tt100k_baselines}"
ATTACKS="${ATTACKS:-TOG,Daedalus,OSFD}"
BATCH="${BATCH:-16}"
IMGSZ="${IMGSZ:-640}"
MAX_SAMPLES="${MAX_SAMPLES:-0}"
FORCE="${FORCE:-0}"
LOG_FILE="${LOG_FILE:-rtdetr_paper_experiments/logs/eval_baselines_tt100k_$(date +%Y%m%d_%H%M%S).log}"
...
echo "Started resumable RT-DETR baseline attack evaluation on TT100K."
echo "PID: $!"
echo "GPU_ID: ${GPU_ID}"
